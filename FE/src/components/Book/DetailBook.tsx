                ...
                <div className="container-fliud">
                    <div className="wrapper row">
                        ...
                        <div className="details col-md-6">
                            <h3 className="product-title">{curBook.title}</h3>
                            <div className="rating">
                                ...
                                <span className="review-no">
                                    <strong>Tác giả: {curBook.author}</strong>
                                </span>
                            </div>
                                ...
                                <h6 className="p-1 flex-fill bd-highlight">
                                    ...
                                    <strong>
                                        <NumericFormat
                                            displayType="text"
                                            value={
                                                (curBook.price -(curBook.discount *curBook.price) /100
                                                ).toString()
                                            }
                                            thousandSeparator={true}
                                            suffix="đ"
                            ...
                            <div className="d-flex bd-highlight">
                                <p className="p-1 flex-fill bd-highlight">
                                    SL Hiện tại:{" "}
                                    <strong>{curBook.quantity.toString()}</strong>
                                </p>
                                <p className="p-1 flex-fill bd-highlight">
                                    Số trang: <strong>{curBook.numPages.toString()}</strong>
                                </p>
                            </div>
                            <div className="d-flex bd-highlight">
                                <p className="p-1 flex-fill bd-highlight">
